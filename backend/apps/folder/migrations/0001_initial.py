    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.IntegerField(choices=[(0, 'unknown'), (1, 'website development'), (2, 'website design'), (3, 'graphic charter'), (4, 'communication strategy'), (5, 'digital strategy')], default=0)),
